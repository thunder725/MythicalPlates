...
public abstract class PlateBase : MonoBehaviour {
    ...
    /// <summary> Different module for the Plate's "has solved" and for the Module's; because of Allmighty Sinnoh </summary>
    [HideInInspector] public bool hasPlateSolved;
